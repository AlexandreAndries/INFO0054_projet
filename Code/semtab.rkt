...
(define (elim-operation operation)
  (match operation
        ((list 'AND a b) (cree-liste-tab (ajout-tab a b)))
        ((list 'OR a b) (cree-liste-tab (ajout-tab a) (ajout-tab b)))
        ((list 'IFTHEN a b) (cree-liste-tab (ajout-tab (mk-NOT a)) (ajout-tab b)))
        ((list 'NAND a b) (cree-liste-tab (ajout-tab (mk-NOT a)) (ajout-tab (mk-NOT b))))
        ((list 'EQUIV a b) (cree-liste-tab (ajout-tab a b) (ajout-tab (mk-NOT a) (mk-NOT b))))
        ((list 'XOR a b) (cree-liste-tab (ajout-tab a (mk-NOT b)) (ajout-tab (mk-NOT a) b)))
        ((list 'XNOR a b) (cree-liste-tab (ajout-tab (mk-NOT a) (mk-NOT b)) (ajout-tab a b)))
        ((list 'NOT (list 'AND a b)) (cree-liste-tab (ajout-tab (mk-NOT a)) (ajout-tab (mk-NOT b))))
        ((list 'NOT (list 'OR a b)) (cree-liste-tab (ajout-tab (mk-NOT a) (mk-NOT b))))
        ((list 'NOT (list 'IFTHEN a b)) (cree-liste-tab (ajout-tab a (mk-NOT b))))
        ((list 'NOT (list 'NOT a)) (cree-liste-tab (ajout-tab a)))
        ((list 'NOT (list 'EQUIV a b)) (cree-liste-tab (ajout-tab (mk-NOT a) b) (ajout-tab a (mk-NOT b))))
        ((list 'NOT a) (cree-liste-tab (ajout-tab(mk-NOT a))))
        (a (cree-liste-tab (ajout-tab a)))
    )
)
; ---------------------------------------------------------------------------- ;
